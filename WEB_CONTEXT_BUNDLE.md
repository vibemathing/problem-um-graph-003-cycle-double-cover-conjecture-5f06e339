...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-graph-003-cycle-double-cover-conjecture-5f06e339-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/GRAPH-003"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-graph-003-cycle-double-cover-conjecture-5f06e339-v1",
      "problem_contract_sha256": "da8ac714e6f8612c16eab977d75d060275941c797f6fe6a1e0a79bc2903ad521",
      "problem_id": "problem:um-graph-003-cycle-double-cover-conjecture-5f06e339",
      "route_id": "route:um-graph-003-cycle-double-cover-conjecture-5f06e339-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-graph-003-cycle-double-cover-conjecture-5f06e339-source-fidelity-01",
      "graph_id": "graph:um-graph-003-cycle-double-cover-conjecture-5f06e339-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-graph-003-cycle-double-cover-conjecture-5f06e339-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-graph-003-cycle-double-cover-conjecture-5f06e339-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Does every bridgeless graph have a collection of cycles covering each edge exactly twice?"
          },
          "statement_sha256": "0cf776c9bf25a97d371de50be02d6ea92d4c259eebe7a0d7d27f2c85569d88ff"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-graph-003-cycle-double-cover-conjecture-5f06e339-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-graph-003-cycle-double-cover-conjecture-5f06e339-root",
      "route_id": "route:um-graph-003-cycle-double-cover-conjecture-5f06e339-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-graph-003-9816f49adc1b",
        "url": "https://www.unsolvedmath.com/problems/GRAPH-003"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
